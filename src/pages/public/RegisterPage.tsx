        ...
        <div className={clsx("w-full max-w-md space-y-8")}>
            ...
            <form className={clsx("mt-8 space-y-6")} action="#" method="POST">
                ...
                <div className={clsx("-space-y-px rounded-md shadow-sm")}>
					<div>
                        <label htmlFor="user-name" className={clsx("sr-only")}>
                        User Name
                        </label>
                        <input
                        id="user-name"
					...
					<div>
                        ...
                        autoComplete="email"
                        required
                        className={clsx("relative block w-full p-3  border-0 py-2 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-m sm:leading-6")}
